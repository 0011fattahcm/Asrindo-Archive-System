...
<head>
  ...
  <title>Tambah Surat Masuk | E-Archive PT Asrindo</title>
  ...
  <div class="ml-64 flex flex-col min-h-screen transition-all duration-300">
    <main class="flex-1 p-6 md:p-8">
      ...
      <div class="flex justify-between items-center mb-8 flex-wrap gap-3">
        <div>
          <h1 class="text-2xl font-bold text-gray-800">Tambah Surat Masuk</h1>
          <p class="text-gray-500 text-sm">Isi formulir di bawah untuk menambahkan surat masuk baru</p>
        </div>
        <a href="index.php"
        ...
        <form action="proses_tambah.php" method="POST" enctype="multipart/form-data"
          ...
          <div class="col-span-2">
            ...
            <input type="text" name="nomor_surat" required
              ...
              focus:border-blue-500 focus:ring-2 focus:ring-blue-400 px-4 py-2.5 transition-all duration-150">
          </div>
          ...
          <div class="col-span-2">
            ...
            <textarea name="ringkasan" rows="3"
              class="w-full rounded-lg border border-gray-300 bg-gray-50 focus:bg-white 
              focus:border-blue-500 focus:ring-2 focus:ring-blue-400 px-4 py-2.5 transition-all duration-150"
              placeholder="Tuliskan ringkasan isi surat..."></textarea>
          </div>
