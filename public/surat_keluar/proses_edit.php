...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // ambil data lama
    $old = mysqli_fetch_assoc(mysqli_query($conn, "SELECT lampiran FROM surat_keluar WHERE id='$id'"));
...
if ($result) {
    logAktivitas($conn, 'Edit Surat Keluar', "Admin ID $admin_id mengedit Surat Keluar ID $id ($nomor_surat - $penerima)");
