...
$query = "
    SELECT nomor_surat, tanggal_surat, tanggal_keluar, penerima, perihal, ringkasan, departemen_id
    FROM surat_keluar
...
$headers = ['No', 'Nomor Surat', 'Tgl Surat', 'Tgl Keluar', 'Penerima', 'Perihal', 'Ringkasan'];
$col = 'A';
...
while ($data = mysqli_fetch_assoc($result)) {
    ...
    $sheet->setCellValue("E$row", $data['penerima']);
...
$filename = "Laporan_Surat_Keluar_{$start}_sd_{$end}.xlsx";

// --- Log Aktivitas ---
$aksi = 'Export Laporan Surat Keluar';
$keterangan = "Admin ID $admin_id mengekspor laporan Surat Keluar dari tanggal $start hingga $end.";
